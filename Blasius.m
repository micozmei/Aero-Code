...
for i = 1:(length(eta)-1)
    a = h.*[G1(eta(i), y1(i), y2(i), y3(i)), G2(eta(i), y1(i), y2(i), y3(i)), G3(eta(i), y1(i), y2(i), y3(i))];
    b = h.*[G1(eta(i), y1(i)+a(1)/2, y2(i)+a(2)/2, y3(i)+a(3)/2), G2(eta(i)+h/2, y1(i)+a(1)/2, y2(i)+a(2)/2, y3(i)+a(3)/2), G3(eta(i)+h/2, y1(i)+a(1)/2, y2(i)+a(2)/2, y3(i)+a(3)/2)];
    c = h.*[G1(eta(i), y1(i)+b(1)/2, y2(i)+b(2)/2, y3(i)+b(3)/2), G2(eta(i)+h/2, y1(i)+b(1)/2, y2(i)+b(2)/2, y3(i)+b(3)/2), G3(eta(i)+h/2, y1(i)+b(1)/2, y2(i)+b(2)/2, y3(i)+b(3)/2)];
    d = h.*[G1(eta(i), y1(i)+c(1), y2(i)+c(2), y3(i)+c(3)), G2(eta(i)+h, y1(i)+c(1), y2(i)+c(2), y3(i)+c(3)), G3(eta(i)+h, y1(i)+c(1), y2(i)+c(2), y3(i)+c(3))];
...
xlim([0 2])
title('Solution to Blasius Equation', 'FontSize', 14);
xlabel('G, G'' and G''''', 'FontSize', 20);
...
title('Boundary Layer Thickness \delta(x)', 'FontSize', 14);
...
title('Shear Stress at the Wall', 'FontSize', 14);
xlabel('x', 'FontSize', 20);
